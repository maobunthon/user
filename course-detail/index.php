...
$datetime = date('Y-m-d h:i:s');
    ...
    if(isset($_POST['save_course'])){
        ...
        $obj_main->redirect('course-detail/');
        ...
        $obj_courseDetail->course_detail_process("update",$_POST['store_id']);
	...
	if(isset($_GET['action'])){
		if($_GET['action']=="edit"){
		    ...
		    $submitName = "edit_course";
            $submitValue = "Update";
            //echo $edit['co_name'];
		}else if ($_GET['action']=="delete"){
            $obj_main->returnQuery("delete from ".COURSE_DETAIL." where co_id='".$_GET['cid']."'");
            $obj_main->redirect('course-detail/');
        }
	}
                                ...
                                <form role="form" action="?" method="post">
                                    <div class="box-body">
                                        <div class="form-group">
											...
											<input type="hidden" class="form-control" name="store_id" value="<?php echo (isset($edit['co_id'])?$edit['co_id']:'');?>" >
                                            <input type="text" class="form-control" id="course_name" name="co_name" value="<?php echo (isset($edit['co_name'])?$edit['co_name']:'');?>" placeholder="course name">
                                            <label for="course_description">Description</label>
                                            <textarea type="text" class="form-control" rows="3" id="course_description" name="co_des" placeholder="course name"><?php echo (isset($edit['co_des'])?$edit['co_des']:'');?></textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-4">
                                                    ...
                                                    <select class="form-control" name="cat_id">
                                                        ...
                                                        ?>
                                                            <option 
                                                            <?php 
                                                                if($myCat['cat_id']== $edit['cat_id']){
                                                                    echo " selected";
                                                                }else{ }
                                                            ?>
                                                            value="<?php echo $myCat['cat_id']?>"><?php echo $myCat['cat_name']?></option>
                                                        <?php
                                                        }
                                                        ?>
                                                    </select>
												...
												<div class="col-xs-4">
                                                    ...
                                                    <select class="form-control" name="br_id">
                                                        ...
                                                        ?>
                                                            <option
                                                             <?php 
                                                                if($myBrand['br_id'] == $edit['br_id']){
                                                                    echo " selected";
                                                                }else{}
                                                            ?>   
                                                             value="<?php echo $myBrand['br_id']?>"><?php echo $myBrand['br_name']?></option>
                                                        <?php
                                                        }
                                                        ?>                                                        
                                                    </select>
                                                ...
                                                <div class="col-xs-4">
                                                    ...
                                                    <input type="text" id="course_fee" name="fee" class="form-control" value="<?php echo (isset($edit['fee'])?$edit['fee']:'');?>" placeholder="">
                                                </div>                                          
                                            </div>
                                            <label for="course_requirement">Requirement</label>
                                            <textarea class="form-control" id="course_requirement" rows="3" name="co_requirement"><?php echo (isset($edit['co_requirement'])?$edit['co_requirement']:'');?></textarea>
                                            <div class="row">
                                                <div class="col-xs-4">
                                                    <label for="course_name">Duration</label>
                                                    <input type="text" class="form-control" name="co_duration" placeholder="" value="<?php echo (isset($edit['co_duration'])?$edit['co_duration']:'');?>">
                                                </div>
                                                <div class="col-xs-4">
                                                    <label for="course_name">Start Date </label>
                                                    <input type="text" class="form-control" placeholder="" name="co_startDate" value="<?php echo (isset($edit['co_startDate'])?$edit['co_startDate']:'');?>">
                                                </div>
                                                <div class="col-xs-4">
                                                    <label for="course_name">Closed Date</label>
                                                    <input type="text" class="form-control" placeholder="" name="co_closeDate" value="<?php echo (isset($edit['co_closeDate'])?$edit['co_closeDate']:'');?>">
                                                </div>
												<div class="col-xs-4">
                                                    <label for="co_endDate">End Date</label>
                                                    <input type="text" class="form-control" placeholder="" name="co_endDate" value="<?php echo (isset($edit['co_endDate'])?$edit['co_endDate']:'');?>">
                                                </div>                                          
                                            </div>                                      
                                            <label for="course_name">tag</label>
                                            <input type="text" class="form-control" id="tag" placeholder="" name="co_tag" value="<?php echo (isset($edit['co_tag'])?$edit['co_tag']:'');?>">
                                            <div class="checkbox">
                                                <label for=""><input type="checkbox" name="co_status" <?php echo (isset($edit['co_status'])?($edit['co_status']==1?' checked="checked"':''):'');?> />status</label>
                                            </div>
                                        </div>
                                    </div><!-- /.box-body -->

                                    <div class="box-footer tac">
                                        <input type="submit" class="btn btn-primary" name="<?php echo $submitName;?>" value="<?php echo $submitValue;?>">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $results = $obj_main->returnQuery("SELECT cd.*,ca.*,b.*,
                                                ...
                                                while ($row = mysqli_fetch_array($results)) {
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td class="alc">
                                                            ...
                                                            <a onclick="return confirm('Are you sure to delete?')" href="?action=delete&cid=<?php echo $row['co_id']?>">
